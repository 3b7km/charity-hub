...
class CspMiddleware
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        $csp = "default-src 'self'; " .
               "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.tailwindcss.com https://js.stripe.com https://maps.googleapis.com https://unpkg.com https://cdn.jsdelivr.net; " .
